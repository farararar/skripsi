...
$router->get('/list-keuangan', 'IncomeController@listKeuangan');
$router->get('/list-belum-lunas', 'IncomeController@listBelumLunas');
$router->post('/income/pelunasan', 'IncomeController@pelunasan');