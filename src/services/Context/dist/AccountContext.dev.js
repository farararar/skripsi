...
var ListAccount = function ListAccount(dispatch) {
  return function () {
    dispatch({
      type: 'LOADING',
    ...
    _axios["default"].get("".concat(_AccountingApi.API, "/account")).then(function (res) {
      if (res.data.success) {
        dispatch({
          type: 'NO-LOADING'
        });
...
var _CreateDataContext = (0, _CreateDataContext2["default"])(AccountReducer, {
